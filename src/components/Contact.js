...
const submitHandler = (e) => {
  ...
  emailjs.sendForm('service_l25i4us', 'template_76jyryd', form.current, '8qPUawSWUFk8CMWha')
    .then((result) => {
    ...
    <div id="contact" className="  py-4 sm:py-6 md:py-10 lg:py-16 lg:section md:my-20 ">
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row">
          ...
          >
            <div >
              <h4 className="text-xl uppercase text-white font-semibold mb-2 tracking-wide">
                get in touch
              </h4>
